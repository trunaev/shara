...
*/
		...
		_init: function() {
			...
			if(this.require.audio) { // If a supplied format is audio
				...
				// this.htmlElement.audio.autobuffer = true;
			}
			...
			this.html.canPlay = {};
			this.flash.canPlay = {};
			//alert( self.htmlElement['audio'].canPlayType('audio/ogg; codecs="vorbis"') );
			//alert( self.htmlElement['audio'].canPlayType('audio/mp3') );
			// alert(self.htmlElement[self.format[format].media].canPlayType('audio/mp3'));
			$.each(this.formats, function(priority, format) {
				//alert (self.format[format].codec);
				//alert (self.format[format].flashCanPlay);
				//alert(self.htmlElement[self.format[format].media].canPlayType(self.format[format].codec));
				self.html.canPlay[format] = self.html[self.format[format].media].available && "" !== self.htmlElement[self.format[format].media].canPlayType(self.format[format].codec);
				self.flash.canPlay[format] = self.format[format].flashCanPlay && self.flash.available;
				
				//alert('html-'+format+'-'+self.html.canPlay[format]);
				//alert('flash-'+format+'-'+self.flash.canPlay[format]);
			});
